...
console.log("---------------- Task 4 --------------------");
getFlavorByIndex(originalFlavors, 2); // Result should be "burgundy cherry" since the originalFlavors array was never modified outside of the addFlavor() function
...
and remove that flavor from the array. 
...
console.log("---------------- Task 5 --------------------");
removeFlavorByName(originalFlavors, "Vanilla"); // doesn't include "Rainbow Sherbert" in length
...
materials highlighting all of their chocolate flavors. Write a function that checks every item in the 
array for a given string and returns a new array called filteredArray with just 
these values. Rather than hardcoding "chocolate" into your function, pass a string as a parameter, 
